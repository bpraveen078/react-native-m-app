    ...
    return (
      <View style={styles.container}>
        <View style={styles.storyContainer}>
          <FlatList data={this.state.fakeContact} keyExtractor={item => item.recordID} 
          extraData={this.state} ListHeaderComponent={this.renderHeader} 
          renderItem={({item}) => {
...
view rawcontactListMultipleSelection.js hosted with ❤ by GitHub